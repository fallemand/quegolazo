...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?v=3&amp;s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C9E740D5:2BEB:6D39BE6:54D521BC" name="octolytics-dimension-request_id" />
...
<meta content="rGeA860cd74JmpJxYMoNkoi7icIMgFDKAZqMCFDVsJrSS/hyRte5QZdNYskjuRT4QR/cTHSBVUWb4lAcYXGI4g==" name="csrf-token" />
...
<a href="/twbs/bootstrap/blob/27677fab5b704d8c61c4561dd7dd55d54fbcc8f2/docs/assets/js/ie10-viewport-bug-workaround.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/twbs/bootstrap/blob/14226-rebased/docs/assets/js/ie10-viewport-bug-workaround.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/carousel-page-vis/docs/assets/js/ie10-viewport-bug-workaround.js"
                 data-name="carousel-page-vis"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="carousel-page-vis">carousel-page-vis</a>
            </div>
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/twitter-handle/docs/assets/js/ie10-viewport-bug-workaround.js"
                 data-name="twitter-handle"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="twitter-handle">twitter-handle</a>
            </div>
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03289s from github-fe137-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
